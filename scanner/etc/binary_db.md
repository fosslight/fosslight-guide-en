...
This guide explains how to connect to FOSSLight Database from FOSSLight Source Scanner and how to set up a separate database for FOSSLight Binary Scanner.
...
## Binary Scanner Database Setup
This section explains how to set up a separate database so FOSSLight Binary Scanner can output OSS information (OSS Name, OSS Version, License) from the database.
